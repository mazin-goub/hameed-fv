...
export function CateringPage({ onBack }: CateringPageProps) {
  const createOrder = useMutatioimport { useMutation, useQuery } from "convex/react";
import { api } from "../../convex/_generated/api";
...
export function CateringPage({ onBack }: CateringPageProps) {
  ...
  const [cateringItems, setCateringItems] = useState([
    { item: "فرخة مندي", quantity: 0 },
    { item: "نص فرخة مندي", quantity: 0 },
    { item: "صدر فرخة ", quantity: 0 },
    { item: "شيش طاووك", quantity: 0 },
    { item: "نفر لحم", quantity: 0 },
    { item: "دوبل لحم", quantity: 0 },
    { item: "كبسة بخاري فراخ", quantity: 0 },
    { item: "فتة مصري", quantity: 0 },
    { item: "مندزانيا", quantity: 0 },
    { item: "لازانيا لحم", quantity: 0 },
    { item: "لازانيا سجق", quantity: 0 },
    { item: "طبق مشكل", quantity: 0 },
  ]);
            ...
            {cateringItems.map((item, index) => (
              <div key={index} className="flex items-center justify-between p-4 rounded-lg" style={{ backgroundColor: '#451a03' }}>
                <div className="flex-1">
                  ...
                  <div className="text-sm" style={{ color: '#d97706' }}>EGP 8 per serving</div>
                </div>
